...
This is a fork of the original repository, because the owner has left it in a largely nonfunctioning state.

Here's a list of the changes I've made:
- Small script and config fixes for specific npcs
- Edge case fixes involving entities despawning
...
- Click the big green "Code" button at the top
- Click "Download Zip" in the menu that pops up.
- Unzip the zip you just downloaded
- Drag everything from inside the mods folder in the zip, into the mods folder in your starbound folder
  - If you need help finding your starbound folder: just right click on the game in steam, and browse local files
